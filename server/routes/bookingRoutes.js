...
router.post(
    ...
    async (req, res) => {
        ...
        const { registrationNumber, roomType, guestCount, checkInDate, checkOutDate } = req.body;
        ...
        try {
            ...
            const booking = new Booking({ registrationNumber, roomType, guestCount, checkInDate, checkOutDate });
            await booking.save();
